...
In this example, individual 2 has RA with probability 0.003, conditional on the
assumption that the population consists of the 8 individuals in the dataset.

In this example, individual 2 has RA with probability 0.77, conditional on the
